...
void output_init( str_par &par, str_dom &dom, str_dyn &dyn, str_stat &stat ) {
  ...
  ncwrap( ncmpi_put_vara_double_all( ncid , sfc_x_varid , st3 , ct3 , stat.sfc_x.get_data() ) , __LINE__ );
  ncwrap( ncmpi_put_vara_double_all( ncid , sfc_y_varid , st3 , ct3 , stat.sfc_y.get_data() ) , __LINE__ );
...
void output( str_par &par, str_dom &dom, str_dyn &dyn, str_stat &stat ) {
  ...
  ncwrap( ncmpi_inq_varid(ncid,"height",&height_varid) , __LINE__ );
  ncwrap( ncmpi_inq_varid(ncid,"uvel"  ,  &uvel_varid) , __LINE__ );
  ncwrap( ncmpi_inq_varid(ncid,"vvel"  ,  &vvel_varid) , __LINE__ );
